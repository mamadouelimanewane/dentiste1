...
export const DENTAL_MODULE_GROUPS: DentalGroup[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 14, name: 'Radio IA',       fullTitle: 'Advanced Neural Imaging',    desc: 'Analyse radiologique assistée par IA.',                                 icon: Scan,    badge: 'IA' },
      { id: 15, name: 'Smile Design',   fullTitle: 'Smile Design Studio Pro',    desc: 'Simulation esthétique du sourire par intelligence artificielle.',        icon: Smile,   badge: 'IA' },
  ...
  },
  {
    ...
    modules: [
      { id: 12, name: 'Dictée IA',      fullTitle: 'Neural Dictation Suite',    desc: 'Transcription vocale et structuration automatique des notes cliniques.',  icon: Brain,     badge: 'IA'  },
